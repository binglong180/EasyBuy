	...
	<table cellpadding="0" cellspacing="0" border="0"
		...
		<tbody>
			<tr class="gradeX">
				...
				<td class="center"><a
					href="javascript:getOrderDetail(${item.id})">${item.serialNumber}</a>
				</td>
				...
				<td class="center"><a
					href="javascript:getOrderDetail(${item.id})" class="edit">查看详情</a>
					&nbsp; <a href="" class="delete">删除</a>
				</td>
			</tr>
			<c:forEach var="item" items="${requestScope.orderDetailList.product}">
				<tr class="gradeX">
					<td align="center"><span class="center"> <input
							type="checkbox" value="${item.id}" /> </span></td>
					<td class="center"><a
